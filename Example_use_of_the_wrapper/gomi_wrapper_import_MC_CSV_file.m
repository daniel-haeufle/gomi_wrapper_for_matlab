function MIWoutdatafile = gomi_wrapper_import_MC_CSV_file(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MIWOUTDATAFILE = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   MIWOUTDATAFILE = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   MIWoutdatafile = importfile('MI_W_out_data_file.csv', 25, 7806);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/08/15 14:35:09
...
MIWoutdatafile = [dataArray{1:end-1}];
