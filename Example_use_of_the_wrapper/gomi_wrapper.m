...
% continuous:
% command = "gomi -s -c -mi MI_W -wi 0,1 -ai 2,3,4,5,6,7 -k " + str(k) + " -file '" + file + "' -o '" + filename + "'"
...
% discrete:
%command = "gomi -mi MI_W -wi 0,1 -ai 2,3,4,5,6,7 -v -sparse -s -bins " + str(b) + " -file '" + file + "' -o '" + filename + "'"
